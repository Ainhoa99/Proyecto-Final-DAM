 ...
 * Use the [GestionCategoriasFragment.newInstance] factory method to
...
class GestionCategoriasFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment GestionCategoriasFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            GestionCategoriasFragment().apply {
