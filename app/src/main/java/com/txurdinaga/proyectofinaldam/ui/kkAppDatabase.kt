...
@Database(entities = [kkEquiposEntity::class, kkCategoryEntity::class, kkLigasEntity::class, kkFotosEntity::class, kkPatrocinadoresEntity::class, kkPartidosEntity::class, kkOcupacionesEntity::class, kkUsersEntity::class], version = 4, exportSchema = false)
