...
@Database(entities = [kkEquiposEntity::class, kkCategoryEntity::class, kkLigasEntity::class, kkFotosEntity::class, kkPatrocinadoresEntity::class], version = 3, exportSchema = false)
